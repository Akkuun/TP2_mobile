...
public class Exercice3Activity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        seekBar.setMax(20); // Set a maximum value for sensitivity
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        if (event.sensor.getType() == Sensor.TYPE_ACCELEROMETER) {
            ...
            //when the magnitude is less than the sensitivity, the background color is green
            if (magnitude < sensitivity) {
                findViewById(R.id.main).setBackgroundColor(Color.GREEN);
            } else if (magnitude >= sensitivity && magnitude < sensitivity * 2) {
